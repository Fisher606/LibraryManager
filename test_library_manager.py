...
class TestLibraryManager(unittest.TestCase):
    ...
    def test_add_book(self):
        ...
        self.assertEqual(new_book.title,
                         "Test Book")
        self.assertEqual(new_book.author,
                         "Test Author")
        self.assertEqual(new_book.year,
                         2024)

    def test_remove_book(self):
        """Тестируем функцию удаления книги"""
        add_book("Book to Remove",
                 "Test Author",
                 2024)
        books_after_add = load_library()
        ...
        self.assertNotIn(book_to_remove,
                         books_after_remove)  # Книга должна быть удалена
    ...
    def test_search_books_by_title(self):
        ...
        self.assertEqual(len(results),
                         1)  # Должна быть найдена только 1 книга
    ...
    def test_search_books_by_author(self):
        ...
        self.assertEqual(len(results),
                         2)  # Должны быть найдены обе книги с таким автором
    ...
    def test_update_book_status(self):
        ...
        update_success = book_to_update.update_book_status(book_id,
                                                           "выдана")
        ...
        self.assertEqual(updated_book.status,
                         "выдана")
